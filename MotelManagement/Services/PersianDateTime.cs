...
namespace ShamisDateTime
{
        ...
        IEquatable<PersianDateTime>, IEquatable<DateTime>
    {
        ...
        public PersianDateTime(int persianYear, int persianMonth, int persianDay, int hour, int minute, int second, int milliseconds)
            : this()
        {
        ...
        /// تنظیم کردن زمان
        /// </summary>
	    public PersianDateTime SetTime(int hour, int minute, int second = 0, int millisecond = 0)
        {
